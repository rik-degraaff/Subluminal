...
HighlightPlayer.prototype.LoadMovie = function( $Container, bUserAction )
{
	...
	else
	{
		...
		var strMessage = 'Se ha producido un error al intentar reproducir este video. Asegúrate de que tu navegador esté actualizado.';
	...
	$.fn.videoControls = function( options ) {
		...
		var overlaySrc = '<div class="html5_video_overlay">' +
				...
				'<div class="control_container">' +
					...
					'<div class="autoplay_label">Autorreproducir vídeos</div>' +
				'</div>' +
