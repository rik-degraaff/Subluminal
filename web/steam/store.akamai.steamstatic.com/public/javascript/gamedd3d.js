...
function ShowShareDialog( )
{
	...
	ShowAlertDialog( "Payla\u015f", $Content).always(
		function() {
			// save it away again for later
			$Content.hide();
			$J(document.body).append( $Content );
...
function InitQueueControls( store_appid, steamworks_appid, next_in_queue_appid, snr )
{
	...
	$IgnoreBtn.click( function() {
		$J.post( 'http://store.steampowered.com/recommended/ignorerecommendation/', {
			...
			ShowAlertDialog( 'İlgilenmiyorum', 'Değişikliklerinizi kaydederken bir sorun oluştu. Lütfen daha sonra tekrar deneyiniz.' );
		});
	});
	...
	$FollowBtn.click( function() {
		$J.post( 'http://store.steampowered.com/explore/followgame/', {
			...
			ShowAlertDialog( 'Takip Et', 'Değişikliklerinizi kaydederken bir sorun oluştu. Lütfen daha sonra tekrar deneyiniz.' );
		});
	});
...
function BuildReviewHistogram()
{
	...
	$J.get( 'http://store.steampowered.com/appreviewhistogram/' + appid, { l: 'turkish' }
	).done( function( data ) {
		...
		var seriesRollup = [ { label: "Olumlu", color: "#66c0f4", fillColor: "#66c0f4", data: chartDataPositive }, { label: "Olumsuz", color: "#A34C25", fillColor: "#A34C25", data: chartDataNegative } ];
		...
		if ( data.results.recent )
		{
			...
			seriesRecent = [ { color: "#66c0f4", label: "Olumlu", data: chartDataPositive }, { color: "#A34C25", label: "Olumsuz", data: chartDataNegative } ];
		}
...
function UpdateActiveFilters()
{
	...
	if ( $J( "#review_date_range_histogram" ).attr( "checked" ) )
	{
		...
		$J( "#review_selected_histogram_date_range_prefix" ).text( 'Sadece Göster ' );
	}
	else if ( $J( "#review_date_range_exclude_histogram" ).attr( "checked" ) )
	{
		bAnyActiveFilters = true;
		$J( "#reviews_filter_graph" ).show();
		$J( "#review_selected_histogram_date_range_prefix" ).text( 'Hariç Tut ' );
	}
	else
	{
...
function ShowReportDialog( nAppId )
{
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_intro' } ).text('Lütfen bu ürünü neden rapor ettiğinize dair bir sebep belirtin.') );

		var rgReportOptions = {"1":"Doland\u0131r\u0131c\u0131l\u0131k - <span class=\"sub\">Bu yaz\u0131l\u0131m sahtekarl\u0131k yoluyla Steam itimatnamesi ya da mali veriler (kredi kart\u0131 bilgileri gibi) gibi hassas bilgilerinizi ele ge\u00e7irmeye \u00e7al\u0131\u015f\u0131r.<\/span>","2":"Zararl\u0131 - <span class=\"sub\">Bu yaz\u0131l\u0131m m\u00fc\u015fterinin bilgisayar\u0131n\u0131 beklenmedik veya zararl\u0131 y\u00f6nde de\u011fi\u015ftiriyor (\u00f6rne\u011fin k\u00f6t\u00fc ama\u00e7l\u0131 yaz\u0131l\u0131m veya vir\u00fcs)<\/span>","3":"Nefret S\u00f6ylevi \u2013 <span class=\"sub\">Nefret i\u00e7erikli s\u00f6ylevler (\u00f6rne\u011fin; belirli etnik k\u00f6kene, inan\u00e7lara, ya\u015fa, \u0131rka, cinsel tercihe ya da sakatl\u0131\u011fa sahip gruplara ya da ki\u015filere kar\u015f\u0131 nefret, \u015fiddet veya ayr\u0131mc\u0131l\u0131k te\u015fvik edebilecek s\u00f6ylemler) bar\u0131nd\u0131r\u0131r<\/span>","4":"Pornografi - <span class=\"sub\">Pornografi i\u00e7eriyor<\/span>","5":"Yeti\u015fkin \u0130\u00e7erik - <span class=\"sub\">Yeti\u015fkin i\u00e7erik olup uygun etiketlenmemi\u015f veya ya\u015f s\u0131n\u0131rlanmam\u0131\u015f<\/span>","6":"Hakaret - <span class=\"sub\"> \u0130ftira veya hakaret i\u00e7eren ifadeler i\u00e7erir<\/span>","7":"Sald\u0131rgan - <span class=\"sub\">A\u00e7\u0131k\u00e7a hakaret i\u00e7eren veya g\u00f6r\u00fcnt\u00fcleyenleri i\u011frendirme veya \u015fok etme ama\u00e7l\u0131 i\u00e7erik bar\u0131nd\u0131r\u0131r<\/span>","8":"\u00c7ocuk \u0130stismar\u0131 - <span class=\"sub\">\u0130\u00e7erik herhangi bir \u015fekilde \u00e7ocuk istismar\u0131n\u0131 i\u00e7eriyor<\/span>","11":"Yasal \u0130hlal - <span class=\"sub\">\u00dclkenizin yasalar\u0131n\u0131 ihlal eden i\u00e7erik i\u00e7eriyor<\/span>","13":"Bozuk - <span class=\"sub\">Minimum sistem gereksinimlerini kar\u015f\u0131layan makinelerde bile indirilemez, ba\u015flat\u0131lamaz veya d\u00fczg\u00fcn \u00e7al\u0131\u015fmaz.<\/span>"};
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_dmca' } ).html('Telif hakkı sahibiyseniz ve Telif Hakkı İhlali\'ni bildirmek istiyorsanız lütfen DMCA uyumlu telif hakkı ihlali formuna <a href="http://steamcommunity.com/dmca/create/">buradan</a> ulaşabilirsiniz.') );
...
{
		var $ModalContent = $J("<div class=\"gotsteamModal\">\r\n\t<div class=\"got_steam_ctn\">\r\n\t<div class=\"got_steam_box\">\r\n\t\t<h1>Steam'iniz var m\u0131?<\/h1>\r\n\t\t<p><a href=\"http:\/\/store.steampowered.com\/about\/\">Steam masa\u00fcst\u00fc uygulamas\u0131na<\/a> sahip olmadan <strong class=\"gotSteam_AppName\"><\/strong> \u00fcr\u00fcn\u00fcn\u00fc y\u00fckleyip \u00e7al\u0131\u015ft\u0131ramazs\u0131n\u0131z. Bilgisayar\u0131n\u0131zda Steam y\u00fckl\u00fc m\u00fc?<\/p>\r\n\t\t<div class=\"gotsteam_buttons\">\r\n\t\t\t<a class=\"gotSteam_SteamURL btn_blue leftbtn\" href=\"\">\r\n\t\t\t\t<h3>Evet, Steam y\u00fckl\u00fc<\/h3>\r\n\t\t\t\t<h5 class=\"gotsteam_action\"><\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<a href=\"http:\/\/store.steampowered.com\/about\/\" class=\"btn_blue\">\r\n\t\t\t\t<h3>Hay\u0131r, Steam'e ihtiyac\u0131m var<\/h3>\r\n\t\t\t\t<h5>Steam hakk\u0131nda okuyun ve indirin<\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<div style=\"clear: left;\"><\/div>\r\n\t\t<\/div>\r\n\t\t<div class=\"got_steam_low_block\">\r\n\t\t\t<div class=\"gotsteam_steam_ico\"><img src=\"http:\/\/store.akamai.steamstatic.com\/public\/images\/v6\/steam_ico.png\" width=\"40\" height=\"40\" border=\"0\" \/><\/div>\r\n\t\t\tSteam, ilk masa\u00fcst\u00fc oyun platformudur. Kat\u0131lmak \u00fccretsizdir ve kullan\u0131m\u0131 olduk\u00e7a kolayd\u0131r. <a href=\"http:\/\/store.steampowered.com\/about\/\">Steam hakk\u0131nda daha fazlas\u0131n\u0131 \u00f6\u011frenin.<\/a>\r\n\t\t<\/div><\/div>\r\n\t<\/div>\r\n<\/div>");
