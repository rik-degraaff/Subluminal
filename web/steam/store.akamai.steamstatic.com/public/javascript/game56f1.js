...
function ShowShareDialog( )
{
	...
	ShowAlertDialog( "Recomand\u0103", $Content).always(
		function() {
			// save it away again for later
			$Content.hide();
			$J(document.body).append( $Content );
...
function InitQueueControls( store_appid, steamworks_appid, next_in_queue_appid, snr )
{
	...
	$IgnoreBtn.click( function() {
		$J.post( 'http://store.steampowered.com/recommended/ignorerecommendation/', {
			...
			ShowAlertDialog( 'Neinteresant', 'A apărut o problemă la salvarea schimbărilor tale. Te rugăm să încerci din nou mai târziu.' );
		});
	});
	...
	$FollowBtn.click( function() {
		$J.post( 'http://store.steampowered.com/explore/followgame/', {
			...
			ShowAlertDialog( 'Abonare', 'A apărut o problemă la salvarea schimbărilor tale. Te rugăm să încerci din nou mai târziu.' );
		});
	});
...
function BuildReviewHistogram()
{
	...
	$J.get( 'http://store.steampowered.com/appreviewhistogram/' + appid, { l: 'romanian' }
	).done( function( data ) {
		...
		var seriesRollup = [ { label: "Pozitive", color: "#66c0f4", fillColor: "#66c0f4", data: chartDataPositive }, { label: "Negative", color: "#A34C25", fillColor: "#A34C25", data: chartDataNegative } ];
		...
		if ( data.results.recent )
		{
			...
			seriesRecent = [ { color: "#66c0f4", label: "Pozitive", data: chartDataPositive }, { color: "#A34C25", label: "Negative", data: chartDataNegative } ];
		}
...
function ShowReportDialog( nAppId )
{
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_intro' } ).text('Te rugăm să alegi un motiv pentru care semnalezi acest produs.') );
		...
		var rgReportOptions = {"1":"Fraud\u0103 - <span class=\"sub\">Acest software \u00eencearc\u0103 s\u0103 colecteze \u00een mod fraudulos informa\u021bii private, cum ar fi datele autentific\u0103rii pe Steam sau informa\u0163ii financiare ale contului (de ex. informa\u021bii despre cardul de credit).<\/span>","2":"D\u0103un\u0103tor - <span class=\"sub\">Acest software modific\u0103 calculatoarele clien\u021bilor \u00een moduri nea\u0219teptate sau d\u0103un\u0103toare (ex. este malware sau virus)<\/span>","3":"Discurs instigator la ur\u0103 - <span class=\"sub\">Con\u0163ine limbaj ostentativ, care instig\u0103 la ur\u0103. De exemplu, un discurs care promoveaz\u0103 ura, violen\u0163a sau discriminarea \u00eempotriva unui grup de persoane sau a unor persoane. Acest tip de discurs folose\u015fte ca pretexte etnia, orientarea religioas\u0103, genul, v\u00e2rsta, orientarea sexual\u0103 sau dizabilit\u0103\u0163ile fizice \u015fi psihice<\/span>","4":"Pornografie - <span class=\"sub\">Con\u021bine pornografie<\/span>","5":"Con\u021binut pentru adul\u021bi - <span class=\"sub\">Con\u021binut pentru adul\u021bi, care nu este etichetat \u00een mod adecvat \u0219i nu este restric\u021bionat conform v\u00e2rstei<\/span>","6":"Def\u0103im\u0103tor - <span class=\"sub\">Con\u021bine declara\u021bii calomnioase sau def\u0103im\u0103toare<\/span>","7":"Ofensator - <span class=\"sub\">Con\u021binut cu caracter ofensator sau care \u00een mod inten\u021bionat este creat pentru a-i \u0219oca sau dezgusta pe spectatori<\/span>","8":"Exploatarea copilului - <span class=\"sub\">Con\u021binut care exploateaz\u0103 copiii \u00een orice mod<\/span>","11":"\u00cenc\u0103lcare a legii - <span class=\"sub\">Con\u021binut care \u00eencalc\u0103 legile din jurisdic\u021bia ta<\/span>","13":"Stricat - <span class=\"sub\">Nu se descarc\u0103, porne\u0219te sau ruleaz\u0103 incorect, chiar \u0219i pe un dispozitiv care \u00eendepline\u0219te cerin\u021bele minime de sistem.<\/span>"};
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_dmca' } ).html('Dacă dorești să raportezi o încălcare a Drepturilor de Autor și tu ești deținătorul drepturilor în cauză, te rugăm să folosești formularul nostru DMCA aflat <a href="http://steamcommunity.com/dmca/create/">aici</a>.') );

	var dialog = ShowConfirmDialog( 'Semnalează acest produs', content, 'Semnalează');
...
{
		var $ModalContent = $J("<div class=\"gotsteamModal\">\r\n\t<div class=\"got_steam_ctn\">\r\n\t<div class=\"got_steam_box\">\r\n\t\t<h1>Ai Steam?<\/h1>\r\n\t\t<p>Trebuie s\u0103 ai <a href=\"http:\/\/store.steampowered.com\/about\/\">aplica\u021bia Steam pentru desktop<\/a> instalat\u0103 \u00eenainte de a instala \u0219i porni <strong class=\"gotSteam_AppName\"><\/strong>. Ai Steam instalat \u00een acest computer?<\/p>\r\n\t\t<div class=\"gotsteam_buttons\">\r\n\t\t\t<a class=\"gotSteam_SteamURL btn_blue leftbtn\" href=\"\">\r\n\t\t\t\t<h3>Da, Steam este instalat<\/h3>\r\n\t\t\t\t<h5 class=\"gotsteam_action\"><\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<a href=\"http:\/\/store.steampowered.com\/about\/\" class=\"btn_blue\">\r\n\t\t\t\t<h3>Nu, am nevoie de Steam<\/h3>\r\n\t\t\t\t<h5>Cite\u0219te despre \u0219i descarc\u0103 Steam<\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<div style=\"clear: left;\"><\/div>\r\n\t\t<\/div>\r\n\t\t<div class=\"got_steam_low_block\">\r\n\t\t\t<div class=\"gotsteam_steam_ico\"><img src=\"http:\/\/store.akamai.steamstatic.com\/public\/images\/v6\/steam_ico.png\" width=\"40\" height=\"40\" border=\"0\" \/><\/div>\r\n\t\t\tSteam se num\u0103r\u0103 printre cele mai bune platforme de gaming pentru PC. Este gratuit\u0103 \u015fi u\u015for de folosit. <a href=\"http:\/\/store.steampowered.com\/about\/\">Afl\u0103 mai multe despre Steam.<\/a>\r\n\t\t<\/div><\/div>\r\n\t<\/div>\r\n<\/div>");
