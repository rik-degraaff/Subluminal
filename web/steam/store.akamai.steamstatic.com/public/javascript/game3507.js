...
function ShowShareDialog( )
{
	...
	ShowAlertDialog( "Partilhar", $Content).always(
		function() {
			// save it away again for later
			$Content.hide();
			$J(document.body).append( $Content );
...
function InitQueueControls( store_appid, steamworks_appid, next_in_queue_appid, snr )
{
	...
	$IgnoreBtn.click( function() {
		$J.post( 'http://store.steampowered.com/recommended/ignorerecommendation/', {
			...
			ShowAlertDialog( 'Dispensar', 'Ocorreu um problema ao guardar as tuas alterações. Por favor, tenta de novo mais tarde.' );
		});
	});
...
function InitAutocollapse()
{
	$J('.game_page_autocollapse').each( function() {
		...
		var $ReadMore = $J('<div/>', {'class': 'game_page_autocollapse_readmore' }).text( 'SABER MAIS' );
...
function BuildReviewHistogram()
{
	...
	$J.get( 'http://store.steampowered.com/appreviewhistogram/' + appid, { l: 'portuguese' }
	).done( function( data ) {
		...
		var seriesRollup = [ { label: "Positivas", color: "#66c0f4", fillColor: "#66c0f4", data: chartDataPositive }, { label: "Negativas", color: "#A34C25", fillColor: "#A34C25", data: chartDataNegative } ];
		...
		if ( data.results.recent )
		{
			...
			seriesRecent = [ { color: "#66c0f4", label: "Positivas", data: chartDataPositive }, { color: "#A34C25", label: "Negativas", data: chartDataNegative } ];
		}
...
function UpdateActiveFilters()
{
	...
	if ( $J( "#purchase_type_steam" ).attr( "checked" ) )
	{
		...
		$J( "#reviews_filter_purchase_type" ).text( 'Comprados no Steam' );
	}
...
function ShowReportDialog( nAppId )
{
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_intro' } ).text('Por favor, seleciona a razão pela qual estás a denunciar este produto.') );
		...
		var rgReportOptions = {"1":"Fraude - <span class=\"sub\">Este software tenta de forma fraudulenta obter informa\u00e7\u00f5es delicadas, tais como credenciais da conta Steam ou dados financeiros (por ex., dados do cart\u00e3o de cr\u00e9dito).<\/span>","2":"Malicioso - <span class=\"sub\">Este software modifica um dispositivo do cliente de maneiras inesperadas ou prejudiciais (Exemplo: \u00e9 malware ou um v\u00edrus)<\/span>","3":"Discurso de \u00f3dio - <span class=\"sub\">Cont\u00e9m mensagens agressivas, ou seja, que incitam ao \u00f3dio, viol\u00eancia ou discrimina\u00e7\u00e3o contra grupos ou pessoas com base na sua etnia, religi\u00e3o, g\u00e9nero, idade, invalidez ou orienta\u00e7\u00e3o sexual<\/span>","4":"Pornografia - <span class=\"sub\">Cont\u00e9m pornografia<\/span>","5":"Conte\u00fado adulto - <span class=\"sub\">Possui conte\u00fado adulto que n\u00e3o est\u00e1 devidamente classificado nem protegido por um sistema de verifica\u00e7\u00e3o de idade<\/span>","6":"Difamat\u00f3rio - <span class=\"sub\">Cont\u00e9m declara\u00e7\u00f5es caluniosas ou difamat\u00f3rias<\/span>","7":"Ofensivo - <span class=\"sub\">Possui conte\u00fados evidentemente ofensivos ou intencionalmente chocantes ou repugnantes<\/span>","8":"Explora\u00e7\u00e3o infantil - <span class=\"sub\">Possui conte\u00fados que exploram crian\u00e7as de qualquer maneira<\/span>","11":"Viola\u00e7\u00e3o da lei - <span class=\"sub\">Possui conte\u00fado que viola leis na tua regi\u00e3o<\/span>","13":"N\u00e3o funcional - <span class=\"sub\">N\u00e3o transfere, inicia, ou corre corretamente, mesmo numa m\u00e1quina que atenda aos requisitos m\u00ednimos do sistema.<\/span>"};
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_dmca' } ).html('(Se deseja denunciar uma violação de direitos de autor e é o possuidor dos mesmos, por favor dirija-se ao nosso formulário de aviso de violação de direitos de autor de acordo com a DMCA que está <a href="http://steamcommunity.com/dmca/create/">aqui</a>.)') );
...
{
		var $ModalContent = $J("<div class=\"gotsteamModal\">\r\n\t<div class=\"got_steam_ctn\">\r\n\t<div class=\"got_steam_box\">\r\n\t\t<h1>Tens o Steam?<\/h1>\r\n\t\t<p>Necessitas de ter a <a href=\"http:\/\/store.steampowered.com\/about\/\">aplica\u00e7\u00e3o Steam<\/a> instalada para que possas instalar e iniciar <strong class=\"gotSteam_AppName\"><\/strong>. Tens o Steam instalado neste computador?<\/p>\r\n\t\t<div class=\"gotsteam_buttons\">\r\n\t\t\t<a class=\"gotSteam_SteamURL btn_blue leftbtn\" href=\"\">\r\n\t\t\t\t<h3>Sim, o Steam est\u00e1 instalado<\/h3>\r\n\t\t\t\t<h5 class=\"gotsteam_action\"><\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<a href=\"http:\/\/store.steampowered.com\/about\/\" class=\"btn_blue\">\r\n\t\t\t\t<h3>N\u00e3o, preciso do Steam<\/h3>\r\n\t\t\t\t<h5>Sabe mais sobre o Steam e transfere-o<\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<div style=\"clear: left;\"><\/div>\r\n\t\t<\/div>\r\n\t\t<div class=\"got_steam_low_block\">\r\n\t\t\t<div class=\"gotsteam_steam_ico\"><img src=\"http:\/\/store.akamai.steamstatic.com\/public\/images\/v6\/steam_ico.png\" width=\"40\" height=\"40\" border=\"0\" \/><\/div>\r\n\t\t\tSteam \u00e9 a plataforma l\u00edder de jogos para computador. \u00c9 f\u00e1cil de usar e o registo \u00e9 gratuito. <a href=\"http:\/\/store.steampowered.com\/about\/\">Fica a saber mais sobre o Steam.<\/a>\r\n\t\t<\/div><\/div>\r\n\t<\/div>\r\n<\/div>");
