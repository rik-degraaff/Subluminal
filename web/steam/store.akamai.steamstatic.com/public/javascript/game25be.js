...
function ShowEmbedWidget( )
{
	...
	var Modal = _BuildDialog( "Vytvo\u0159it \u0161t\u00edtek", $Content, [], fnOK, {} );
...
function ShowShareDialog( )
{
	...
	ShowAlertDialog( "Sd\u00edlet", $Content).always(
		function() {
			// save it away again for later
			$Content.hide();
			$J(document.body).append( $Content );
...
function InitQueueControls( store_appid, steamworks_appid, next_in_queue_appid, snr )
{
	...
	$IgnoreBtn.click( function() {
		$J.post( 'http://store.steampowered.com/recommended/ignorerecommendation/', {
			...
			ShowAlertDialog( 'Nemám zájem', 'Při ukládání Vašich změn došlo k chybě. Zkuste to prosím později.' );
		});
	});
	...
	$FollowBtn.click( function() {
		$J.post( 'http://store.steampowered.com/explore/followgame/', {
			...
			ShowAlertDialog( 'Sledovat', 'Při ukládání Vašich změn došlo k chybě. Zkuste to prosím později.' );
		});
	});
	...
	$J('a.dq_settings_link').click( function() {
		CDiscoveryQueue.ShowCustomizeDialog( function( data ) {
			...
			{
				ShowConfirmDialog( 'Upravte si Vaši frontu doporučení', 'Fronta doporučení byla upravena podle Vašich požadavků. Co si přejete udělat nyní?',
					'Projít si novou frontu','Zůstat tady'
				).done( function() {
...
function BuildReviewHistogram()
{
	...
	$J.get( 'http://store.steampowered.com/appreviewhistogram/' + appid, { l: 'czech' }
	).done( function( data ) {
		...
		var seriesRollup = [ { label: "Kladné", color: "#66c0f4", fillColor: "#66c0f4", data: chartDataPositive }, { label: "Záporné", color: "#A34C25", fillColor: "#A34C25", data: chartDataNegative } ];
		...
		if ( data.results.recent )
		{
			...
			seriesRecent = [ { color: "#66c0f4", label: "Kladné", data: chartDataPositive }, { color: "#A34C25", label: "Záporné", data: chartDataNegative } ];
		}
...
function ShowReportDialog( nAppId )
{
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_intro' } ).text('Vyberte prosím důvod, proč chcete nahlásit tento produkt.') );

		var rgReportOptions = {"1":"Podvod \u2013 <span class=\"sub\">Tento software se podvodn\u00fdm zp\u016fsobem pokou\u0161\u00ed shrom\u00e1\u017edit citliv\u00e1 data, jako jsou p\u0159ihla\u0161ovac\u00ed \u00fadaje ke slu\u017eb\u011b Steam nebo platebn\u00ed \u00fadaje (nap\u0159. \u00fadaje o kreditn\u00edch kart\u00e1ch)<\/span>","2":"\u0160kodlivost \u2013 <span class=\"sub\">Tento software zp\u016fsobuje nep\u0159edv\u00eddan\u00e9 a \u0161kodliv\u00e9 z\u00e1sahy v po\u010d\u00edta\u010di z\u00e1kazn\u00edka (obsahuje malware nebo po\u010d\u00edta\u010dov\u00e9 viry)<\/span>","3":"Nen\u00e1vistn\u00e9 projevy \u2013 <span class=\"sub\">Obsahuje projevy nen\u00e1visti, tedy v\u00fdroky podporuj\u00edc\u00ed nen\u00e1vist, n\u00e1sil\u00ed nebo diskriminaci skupin \u010di jednotlivc\u016f na z\u00e1klad\u011b etnick\u00e9ho p\u016fvodu, n\u00e1bo\u017eenstv\u00ed, pohlav\u00ed, v\u011bku, t\u011blesn\u00e9ho posti\u017een\u00ed nebo sexu\u00e1ln\u00ed orientace<\/span>","4":"Pornografie \u2013 <span class=\"sub\">Obsahuje pornografii<\/span>","5":"Obsah pro dosp\u011bl\u00e9 \u2013 <span class=\"sub\">Obsahuje obsah ur\u010den\u00fd dosp\u011bl\u00fdm, kter\u00fd nen\u00ed ozna\u010den odpov\u00eddaj\u00edc\u00edm zp\u016fsobem a omezen v\u011bkovou p\u0159\u00edstupnost\u00ed<\/span>","6":"Nevhodnost \u2013 <span class=\"sub\">Obsahuje ur\u00e1\u017eliv\u00e9 nebo hanliv\u00e9 v\u00fdroky<\/span>","7":"Ur\u00e1\u017elivost \u2013 <span class=\"sub\">Zahrnuje obsah, kter\u00fd je zjevn\u011b ur\u00e1\u017eliv\u00fd a jeho\u017e c\u00edlem je \u0161okovat \u010di pohor\u0161it u\u017eivatele<\/span>","8":"Zneu\u017eiv\u00e1n\u00ed d\u011bt\u00ed \u2013 <span class=\"sub\">Zahrnuje obsah, kter\u00fd vyobrazuje \u010di jinak podporuje zneu\u017e\u00edv\u00e1n\u00ed d\u011bti<\/span>","11":"Poru\u0161en\u00ed pr\u00e1v \u2013 <span class=\"sub\">Zahrnuje obsah, kter\u00fd poru\u0161uje pr\u00e1vn\u00ed \u0159\u00e1d m\u00e9ho st\u00e1tu<\/span>","13":"Nefunk\u010dnost \u2013 <span class=\"sub\">Nelze st\u00e1hnout, spustit nebo spr\u00e1vn\u011b provozovat, p\u0159esto\u017ee za\u0159\u00edzen\u00ed spl\u0148uje minim\u00e1ln\u00ed syst\u00e9mov\u00e9 po\u017eadavky<\/span>"};
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_dmca' } ).html('Pokud jste držitelem autorských práv a chcete nahlásit jejich porušení, pokračujte prosím na náš formulář pro upozornění na porušování autorských práv podle zákona DMCA <a href="http://steamcommunity.com/dmca/create/">zde</a>.') );
		...
		if ( eReportTypeSelected )
		{
			$J.post(
				'http://store.steampowered.com/appreport/' + nAppId + '/report/',
				{
					...
					{
						ShowAlertDialog( 'Chyba', 'Při ukládání Vašeho nahlášení došlo k chybě. Zkuste to prosím později znovu.' );
					}
...
{
		var $ModalContent = $J("<div class=\"gotsteamModal\">\r\n\t<div class=\"got_steam_ctn\">\r\n\t<div class=\"got_steam_box\">\r\n\t\t<h1>M\u00e1te klienta slu\u017eby Steam?<\/h1>\r\n\t\t<p><a href=\"http:\/\/store.steampowered.com\/about\/\">Klient slu\u017eby Steam<\/a> je vy\u017eadovan\u00fd pro spu\u0161t\u011bn\u00ed aplikace <strong class=\"gotSteam_AppName\"><\/strong>. M\u00e1te klienta nainstalovan\u00e9ho?<\/p>\r\n\t\t<div class=\"gotsteam_buttons\">\r\n\t\t\t<a class=\"gotSteam_SteamURL btn_blue leftbtn\" href=\"\">\r\n\t\t\t\t<h3>Ano, m\u00e1m klienta slu\u017eby Steam<\/h3>\r\n\t\t\t\t<h5 class=\"gotsteam_action\"><\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<a href=\"http:\/\/store.steampowered.com\/about\/\" class=\"btn_blue\">\r\n\t\t\t\t<h3>Ne, mus\u00edm jej nainstalovat<\/h3>\r\n\t\t\t\t<h5>St\u00e1hnout klienta slu\u017eby Steam<\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<div style=\"clear: left;\"><\/div>\r\n\t\t<\/div>\r\n\t\t<div class=\"got_steam_low_block\">\r\n\t\t\t<div class=\"gotsteam_steam_ico\"><img src=\"http:\/\/store.akamai.steamstatic.com\/public\/images\/v6\/steam_ico.png\" width=\"40\" height=\"40\" border=\"0\" \/><\/div>\r\n\t\t\tSteam je jedna z p\u0159edn\u00edch hern\u00edch platforem. Klient je zdarma a jednoduch\u00fd na ovl\u00e1d\u00e1n\u00ed. <a href=\"http:\/\/store.steampowered.com\/about\/\">Zjistit v\u00edce o slu\u017eb\u011b Steam.<\/a>\r\n\t\t<\/div><\/div>\r\n\t<\/div>\r\n<\/div>");
...
{
	var strTemplate = "<div class=\"recommended_more_info_modal\">\r\n\t\t\t\t\t\t\t\t<p class=\"intro\">Nalezli jste produkt, jen\u017e se nepodob\u00e1 \u017e\u00e1dn\u00e9mu z produkt\u016f, kter\u00fd jste pou\u017eili v minulosti. Slu\u017eba Steam Va\u0161e preference zakl\u00e1d\u00e1 na hr\u00e1ch, kter\u00e9 jste hr\u00e1li, filmech, kter\u00e9 jste sledovali a softwaru, kter\u00fd jste ve slu\u017eb\u011b Steam pou\u017e\u00edvali. Tuto aktivitu vyu\u017eijeme tak, abychom V\u00e1m mohli p\u0159izp\u016fsobit doporu\u010den\u00ed na z\u00e1klad\u011b Va\u0161eho vkusu.<\/p>\r\n\t\t\t\t\t\t\t\t<h2>L\u00edb\u00ed se V\u00e1m tento produkt?<\/h2>\r\n\t\t\t\t\t\t\t\t<p>Pokud se V\u00e1m tento produkt l\u00edb\u00ed a zahrajete si\/pou\u017eijete jej, vezmeme tuto skute\u010dnost na v\u011bdom\u00ed p\u0159i vytv\u00e1\u0159en\u00ed budouc\u00edch doporu\u010den\u00ed.<\/p>\r\n\t\t\t\t\t\t\t\t<h2>Produkty podobn\u00e9 tomuto se V\u00e1m nel\u00edb\u00ed?<\/h2>\r\n\t\t\t\t\t\t\t\t<p>Sv\u00e9 p\u0159edvolby obchodu m\u016f\u017eete rovn\u011b\u017e nastavit tak, abyste slu\u017eb\u011b Steam uk\u00e1zali zna\u010dky \u010di typy produkt\u016f, o kter\u00e9 nem\u00e1te z\u00e1jem. <a href=\"https:\/\/store.steampowered.com\/account\/preferences\/\">Upravit p\u0159edvolby obchodu<\/a>.<\/p>\r\n\t\t\t\t\t\t\t<\/div>";
