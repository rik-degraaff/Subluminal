...
function FollowCuratorWithCallback( clanID, bFollow, onComplete )
{
	...
	if ( !bHaveUser )
	{
		ShowAlertDialog("Por favor, inicie a sess\u00e3o", "Inicie a sess\u00e3o para seguir um curador");
		return;
	}
	...
	$J.post(
		...
		{
			ShowAlertDialog( 'Erro', 'Houve um problema ao tentar seguir um Curador Steam.' );
		}
	);
	return false;
}
...
function IgnoreCuratorWithCallback( clanID, bIgnore, onComplete )
{
	...
	if ( !bHaveUser )
	{
		ShowAlertDialog("Por favor, inicie a sess\u00e3o", "Inicie a sess\u00e3o para ignorar um Curador Steam");
		return;
	}
	...
	$J.post(
		...
		{
			ShowAlertDialog( 'Erro', 'Houve um problema ao ignorar o Curador Steam.' );
		}
	);
	return false;
}
