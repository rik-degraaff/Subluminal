...
HighlightPlayer.prototype.LoadMovie = function( $Container, bUserAction )
{
	...
	else
	{
		...
		var strMessage = 'Det gick inte att spela den här filmen. Vänligen se till att din webbläsare är uppdaterad.';
...
HighlightPlayer.prototype.ShowScreenshotPopup = function( screenshotid )
{
	...
	var fnUpdateFooter = function()
	{
		...
		$ScreenshotCount.text( '%1$s av %2$s skärmdumpar'.replace( /%1\$s/, iCurIndex + 1 ).replace( /%2\$s/, rgScreenshotIDs.length ) );
	};
	...
	$.fn.videoControls = function( options ) {
		...
		var overlaySrc = '<div class="html5_video_overlay">' +
				...
				'<div class="control_container">' +
					...
					'<div class="autoplay_label">Spela filmer automatiskt</div>' +
				'</div>' +
