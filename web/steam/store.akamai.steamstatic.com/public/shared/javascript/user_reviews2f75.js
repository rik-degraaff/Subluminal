...
function UserReview_Rate( recommendationID, bRateUp, baseURL, callback )
{
	$J.post( baseURL + '/userreviews/rate/' + recommendationID,{
		...
		{
			ShowAlertDialog( 'Erro', 'Tens de ter a sessão iniciada para realizar essa ação.' );
		}
		...
		{
			ShowAlertDialog( 'Erro', 'A tua conta não cumpre os requisitos necessários para a utilização desta funcionalidade. <a class="whiteLink" href="https://help.steampowered.com/pt/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Visita o Suporte Steam</a> para mais informações.' );
		}
		else
		{
...
{
	var dialog = ShowConfirmDialog( 'Remover motivo da sinalização por desenvolvedor', 'Esta análise foi sinalizada pelo desenvolvedor. Apagar a sinalização?' );
	dialog.done( function() {
...
function UserReview_SetDeveloperResponse( recommendationID, recommendation, baseURL, callback )
{
	...
	var explanation = $J('<div/>', { 'class': 'user_review_report_dialog_explanation' } );
	explanation.html( 'Podes responder a esta análise como representante oficial. A resposta será visível a todos os que podem ver esta análise e estará sinalizada devidamente como do desenvolvedor.' );
