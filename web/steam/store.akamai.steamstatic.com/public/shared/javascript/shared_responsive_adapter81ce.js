		...
		$SelectBox.append(
			$J('<option/>', {value: "turkish"} ).text( 'Türkçe' )
				...
				$J('<option/>', {value: "danish"} ).text( 'Dansk (Danca)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "dutch"} ).text( 'Nederlands (Felemenkçe)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (Lehçe)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (Portekizce)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português-Brasil (Brezilya Portekizcesi)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (Basitleştirilmiş Çince)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español (İspanyolca)' )
			);
					$SelectBox.append(
