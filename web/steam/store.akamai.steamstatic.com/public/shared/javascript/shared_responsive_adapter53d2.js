	...
	$MenuItem.click( function() {
		...
		$SelectBox.append(
			$J('<option/>', {value: "bulgarian"} ).text( 'български (Bulgarian)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "czech"} ).text( 'čeština (чешки)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "danish"} ).text( 'Dansk (датски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "dutch"} ).text( 'Nederlands (холандски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "english"} ).text( 'English (английски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "finnish"} ).text( 'Suomi (фински)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "french"} ).text( 'Français (френски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "greek"} ).text( 'Ελληνικά (гръцки)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "german"} ).text( 'Deutsch (немски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "hungarian"} ).text( 'Magyar (унгарски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "italian"} ).text( 'Italiano (италиански)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "japanese"} ).text( '日本語 (японски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "koreana"} ).text( '한국어 (корейски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "norwegian"} ).text( 'Norsk (норвежки)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "polish"} ).text( 'Polski (полски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (португалски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português-Brasil (бразилски португалски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "russian"} ).text( 'Русский (руски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "romanian"} ).text( 'Română (румънски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (опростен китайски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español (испански)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "swedish"} ).text( 'Svenska (шведски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "tchinese"} ).text( '繁體中文 (традиционен китайски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "thai"} ).text( 'ไทย (тайландски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "turkish"} ).text( 'Türkçe (турски)' )
			);
		...
		Modal = ShowConfirmDialog( 'Смяна на езикa', $LanguageForm, 'Смяна на езикa' ).done( fnChangeLanguage );
		$SelectBox.focus();
	});
}
