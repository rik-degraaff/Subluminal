		...
		$SelectBox.append(
			$J('<option/>', {value: "finnish"} ).text( 'Suomi' )
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (puola)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (portugali)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português-Brasil (brasilianportugali)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (yksinkertaistettu kiina)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español (espanja)' )
			);
					$SelectBox.append(
