...
function UserReview_Rate( recommendationID, bRateUp, baseURL, callback )
{
	$J.post( baseURL + '/userreviews/rate/' + recommendationID,{
		...
		{
			ShowAlertDialog( 'Virhe', 'Sinun on kirjauduttava sisään, jotta voit suorittaa tämän toiminnon.' );
		}
...
function UserReview_Report( recommendationID, baseURL, callback )
{
	...
	explanation.html( 'Ole hyvä ja kerro miksi tämä arvostelu rikkoo Steamin käyttöehtoja tai käyttäytymissääntöjä. Tätä ei voi peruuttaa.' );
...
{
	var dialog = ShowPromptWithTextAreaDialog( 'Päivitä arvostelusi', existingText, null, null, 4096 );
...
{
	var dialog = ShowConfirmDialog( 'Poista kehittäjän ilmoituksen syy', 'Kehittäjä on ilmoittanut tästä arvostelusta. Tahdotko varmasti poistaa tämän tilan?' );
	dialog.done( function() {
...
function UserReview_SetDeveloperResponse( recommendationID, recommendation, baseURL, callback )
{
	...
	var explanation = $J('<div/>', { 'class': 'user_review_report_dialog_explanation' } );
	explanation.html( 'Voit vastata tähän arvosteluun virallisesti. Tämä vastaus tulee näkymään kaikille, jotka näkevät tämän arvostelun, ja sen merkataan olevan kehittäjältä.' );
...
{
	var dialog = ShowConfirmDialog( 'Poista ilmoitukset', 'Tahdotko varmasti poistaa kaikki ilmoitukset? Tätä toimintoa ei voi peruuttaa!' );
	dialog.done( function() {
