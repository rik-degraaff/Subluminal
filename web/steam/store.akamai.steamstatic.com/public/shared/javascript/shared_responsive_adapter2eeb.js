		...
		$SelectBox.append(
			$J('<option/>', {value: "hungarian"} ).text( 'Magyar (Hungarian)' )
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (lengyel)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (portugál)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português-Brasil (portugál-brazil)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (egyszerűsített kínai)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español (spanyol)' )
			);
					$SelectBox.append(
