		...
		$SelectBox.append(
			$J('<option/>', {value: "swedish"} ).text( 'Svenska' )
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (polska)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (portugisiska)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português-Brasil (brasiliansk portugisiska)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (förenklad kinesiska)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español (spanska)' )
			);
					$SelectBox.append(
