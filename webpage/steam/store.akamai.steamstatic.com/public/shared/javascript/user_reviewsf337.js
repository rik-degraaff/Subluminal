...
function UserReview_Rate( recommendationID, bRateUp, baseURL, callback )
{
	$J.post( baseURL + '/userreviews/rate/' + recommendationID,{
		...
		{
			ShowAlertDialog( 'Feil', 'Du må være pålogget for å utføre den handlingen.' );
		}
		else if ( results.success == 15 )
		{
			ShowAlertDialog( 'Feil', 'Kontoen din har ikke nok privilegier til å utføre denne handlingen.' );
		}
...
{
	var dialog = ShowPromptWithTextAreaDialog( 'Rapportér anmeldelse', '', null, null, 1000 );
	var explanation = $J('<div/>', { 'class': 'user_review_report_dialog_explanation' } );
	explanation.html( 'Vennligst skriv inn grunnen til hvorfor du rapporterer denne anmeldelsen for brudd på Steams vilkår for bruk eller regler for oppførsel på nett. Dette kan ikke angres.' );
