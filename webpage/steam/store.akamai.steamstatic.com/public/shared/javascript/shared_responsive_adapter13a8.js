		...
		$SelectBox.append(
			$J('<option/>', {value: "greek"} ).text( 'Ελληνικά (Greek)' )
				...
				$J('<option/>', {value: "japanese"} ).text( '日本語 (Ιαπωνικά)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "koreana"} ).text( '한국어 (Κορεάτικα)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (Πολωνικά)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (Πορτογαλικά)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português-Brasil (Πορτογαλικά Βραζιλίας)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "russian"} ).text( 'Русский (Ρώσικα)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "romanian"} ).text( 'Română (Ρουμανικά)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (Απλοποιημένα Κινέζικα)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español (Ισπανικά)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "swedish"} ).text( 'Svenska (Σουηδικά)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "tchinese"} ).text( '繁體中文 (Παραδοσιακά Κινέζικα)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "thai"} ).text( 'ไทย (Ταϊλανδέζικα)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "turkish"} ).text( 'Türkçe (Τούρκικα)' )
			);
