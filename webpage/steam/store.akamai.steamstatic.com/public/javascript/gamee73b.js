...
function ShowEmbedWidget( )
{
	...
	var Modal = _BuildDialog( "\u0421\u0442\u0432\u043e\u0440\u0435\u043d\u043d\u044f \u0432\u0431\u0443\u0434\u043e\u0432\u0430\u043d\u043e\u0433\u043e \u0432\u0435\u0431-\u0432\u0456\u0434\u0436\u0435\u0442\u0430", $Content, [], fnOK, {} );
...
function ShowShareDialog( )
{
	...
	ShowAlertDialog( "\u041f\u043e\u0434\u0456\u043b\u0438\u0442\u0438\u0441\u044f", $Content).always(
		function() {
			// save it away again for later
			$Content.hide();
			$J(document.body).append( $Content );
...
function InitQueueControls( store_appid, steamworks_appid, next_in_queue_appid, snr )
{
	...
	$IgnoreBtn.click( function() {
		$J.post( 'http://store.steampowered.com/recommended/ignorerecommendation/', {
			...
			if ( data && data.nSaleTaskCompleted ) { NewStickerPackModal( 'Позначте щось як нецікаве' ); } // SummerSale2017
		}).fail( function( jqXHR ) {
			ShowAlertDialog( 'Не цікавить', 'Виникла проблема під час збереження ваших змін. Будь ласка, спробуйте знову пізніше.' );
		});
	});
	...
	$FollowBtn.click( function() {
		$J.post( 'http://store.steampowered.com/explore/followgame/', {
			...
			ShowAlertDialog( 'Слідкувати', 'Виникла проблема під час збереження ваших змін. Будь ласка, спробуйте знову пізніше.' );
		});
	});
	...
	$J('a.dq_settings_link').click( function() {
		CDiscoveryQueue.ShowCustomizeDialog( function( data ) {
			...
			{
				ShowConfirmDialog( 'Налаштування черги знахідок', 'Ми створили вам нову чергу знахідок з урахуванням ваших налаштувань. Що ви бажаєте зробити?',
					'Почати досліджувати нову чергу','Залишатися тут'
				).done( function() {
...
function InitAutocollapse()
{
	$J('.game_page_autocollapse').each( function() {
		...
		var $ReadMore = $J('<div/>', {'class': 'game_page_autocollapse_readmore' }).text( 'ЧИТАТИ ДАЛІ' );
...
function UserReviewVoteUp( id )
{
	UserReview_Rate( id, true, 'http://store.steampowered.com/',
		function( rgResults ) {
			if ( rgResults.nSaleTaskCompleted ) { NewStickerPackModal( 'Позначте рецензію як корисну… або навпаки');}
...
function BuildReviewHistogram()
{
	...
	$J.get( 'http://store.steampowered.com/appreviewhistogram/' + appid, { l: 'ukrainian' }
	).done( function( data ) {
		...
		var seriesRollup = [ { label: "Позитивні", color: "#66c0f4", fillColor: "#66c0f4", data: chartDataPositive }, { label: "Негативні", color: "#A34C25", fillColor: "#A34C25", data: chartDataNegative } ];
		...
		if ( data.results.recent )
		{
			...
			seriesRecent = [ { color: "#66c0f4", label: "Позитивні", data: chartDataPositive }, { color: "#A34C25", label: "Негативні", data: chartDataNegative } ];
		}
...
function UpdateActiveFilters()
{
	...
	if ( $J( "#review_type_positive" ).attr( "checked" ) )
	{
		...
		$J( "#reviews_filter_type" ).text( 'Позитивні' );
	}
	else if ( $J( "#review_type_negative" ).attr( "checked" ) )
	{
		bAnyActiveFilters = true;
		$J( "#reviews_filter_type" ).show();
		$J( "#reviews_filter_type" ).text( 'Негативні' );
	}
	else
	{
	...
	if ( $J( "#purchase_type_steam" ).attr( "checked" ) )
	{
		...
		$J( "#reviews_filter_purchase_type" ).text( 'Придбано у Steam' );
	}
	else if ( $J( "#purchase_type_non_steam" ).attr( "checked" ) )
	{
		bAnyActiveFilters = true;
		$J( "#reviews_filter_purchase_type" ).show();
		$J( "#reviews_filter_purchase_type" ).text( 'Придбано не у Steam' );
	}
	else
	{
	...
	if ( $J( "#review_language_mine" ).attr( "checked" ) )
	{
		...
		$J( "#reviews_filter_language" ).text( 'Обрані мови' );
	}
	else
	{
	...
	if ( $J( "#review_date_range_histogram" ).attr( "checked" ) )
	{
		...
		$J( "#review_selected_histogram_date_range_prefix" ).text( 'переглянути лише ' );
	}
	else if ( $J( "#review_date_range_exclude_histogram" ).attr( "checked" ) )
	{
		bAnyActiveFilters = true;
		$J( "#reviews_filter_graph" ).show();
		$J( "#review_selected_histogram_date_range_prefix" ).text( 'Виключити ' );
	}
	else
	{
...
function ShowReportDialog( nAppId )
{
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_intro' } ).text('Будь ласка, виберіть причину скарги на цей продукт.') );

		var rgReportOptions = {"1":"\u0428\u0430\u0445\u0440\u0430\u0439\u0441\u0442\u0432\u043e \u2013 <span class=\"sub\">\u0426\u0435 \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043d\u0435 \u0437\u0430\u0431\u0435\u0437\u043f\u0435\u0447\u0435\u043d\u043d\u044f \u043d\u0430\u043c\u0430\u0433\u0430\u0454\u0442\u044c\u0441\u044f \u0448\u0430\u0445\u0440\u0430\u0439\u0441\u044c\u043a\u0438\u043c \u0448\u043b\u044f\u0445\u043e\u043c \u0437\u0456\u0431\u0440\u0430\u0442\u0438 \u0432\u0430\u0436\u043b\u0438\u0432\u0443 \u0456\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0456\u044e, \u0442\u0430\u043a\u0443 \u044f\u043a \u0434\u0430\u043d\u0456 \u0434\u043b\u044f \u0432\u0445\u043e\u0434\u0443 \u0443 Steam \u0430\u0431\u043e \u0444\u0456\u043d\u0430\u043d\u0441\u043e\u0432\u0443 \u0456\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0456\u044e (\u043d\u0430\u043f\u0440\u0438\u043a\u043b\u0430\u0434, \u0434\u0430\u043d\u0456 \u0432\u0430\u0448\u043e\u0457 \u043a\u0440\u0435\u0434\u0438\u0442\u043d\u043e\u0457 \u043a\u0430\u0440\u0442\u043a\u0438).<\/span>","2":"\u0428\u043a\u0456\u0434\u043b\u0438\u0432\u0435 \u041f\u0417 - <span class=\"sub\">\u0426\u0435 \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043d\u0435 \u0437\u0430\u0431\u0435\u0437\u043f\u0435\u0447\u0435\u043d\u043d\u044f \u0437\u043c\u0456\u043d\u044e\u0454 \u043a\u043e\u043c\u043f\u2019\u044e\u0442\u0435\u0440 \u043a\u043e\u0440\u0438\u0441\u0442\u0443\u0432\u0430\u0447\u0430 \u0443 \u043d\u0435\u043f\u0435\u0440\u0435\u0434\u0431\u0430\u0447\u0443\u0432\u0430\u043d\u0438\u0439 \u0430\u0431\u043e \u043d\u0435\u0431\u0435\u0437\u043f\u0435\u0447\u043d\u0438\u0439 \u0441\u043f\u043e\u0441\u0456\u0431 (\u043d\u0430\u043f\u0440\u0438\u043a\u043b\u0430\u0434, \u0448\u043a\u0456\u0434\u043b\u0438\u0432\u0430 \u043f\u0440\u043e\u0433\u0440\u0430\u043c\
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_intro' } ).text('Тут ви можете ввести додаткову інформацію:') );
	content.append( textArea );

	content.append( $J('<div/>', {'class': 'app_report_dialog_dmca' } ).html('Якщо ви бажаєте повідомити про порушення авторського права, власником якого ви є, будь ласка, натисніть <a href="http://steamcommunity.com/dmca/create/">сюди</a> та заповніть форму про порушення DMCA.') );

	var dialog = ShowConfirmDialog( 'Скарга на продукт', content, 'Поскаржитись');
	...
	dialog.done( function() {
		...
		if ( eReportTypeSelected )
		{
			$J.post(
				'http://store.steampowered.com/appreport/' + nAppId + '/report/',
				{
					...
					if ( json.success == 29 )
					{
						ShowAlertDialog( 'Помилка', 'Ви вже скаржились на цей продукт!' );
						gReportedApp = true;
						$J( "#ReportAppBtn").addClass( 'btn_active' );
					}
					else
		...
		{
			ShowAlertDialog( 'Помилка', 'Ви маєте вказати причину скарги на цей продукт!' );
		}
	});
}
...
{
		var $ModalContent = $J("<div class=\"gotsteamModal\">\r\n\t<div class=\"got_steam_ctn\">\r\n\t<div class=\"got_steam_box\">\r\n\t\t<h1>\u041c\u0430\u0454\u0442\u0435 Steam?<\/h1>\r\n\t\t<p>\u0412\u0430\u043c \u043d\u0435\u043e\u0431\u0445\u0456\u0434\u043d\u043e \u043c\u0430\u0442\u0438 <a href=\"http:\/\/store.steampowered.com\/about\/\">\u043d\u0430\u0441\u0442\u0456\u043b\u044c\u043d\u0443 \u043a\u043b\u0456\u0454\u043d\u0442\u0441\u044c\u043a\u0443 \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u0443 Steam<\/a> \u0434\u043b\u044f \u0442\u043e\u0433\u043e, \u0430\u0431\u043e \u0456\u043d\u0441\u0442\u0430\u043b\u044e\u0432\u0430\u0442\u0438 \u0439 \u0437\u0430\u043f\u0443\u0441\u0442\u0438\u0442\u0438 <strong class=\"gotSteam_AppName\"><\/strong>. \u0427\u0438 \u0454 Steam \u043d\u0430 \u0432\u0430\u0448\u043e\u043c\u0443 \u043a\u043e\u043c\u043f\u2019\u044e\u0442\u0435\u0440\u0456?<\/p>\r\n\t\t<div class=\"gotsteam_buttons\">\r\n\t\t\t<a class=\"gotSteam_SteamURL btn_blue leftbtn\" href=\"\">\r\n\t\t\t\t<h3>\u0422\u0430\u043a, Steam \u0432\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u043e<\/h3>\r\n\t\t\t\t<h5 class=\"gotsteam_action\"><\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<a href=\"http:\/\/store.steampowered.com\/about\/\" class=\"btn_blue\">\r\n\t\t\t\t<h3>\u041d\u0456, \u043c\u0435\u043d\u0456 \u043f\u043e\u0442\u0440\u0456\u0431\u0435\u043d Steam<\/h3>\r\n\t\t\t\t<h5>\u041f\u0440\u043e\u0447\u0438\u0442\u0430\u0442\u0438 \u043e\u043f\u0438\u0441 \u0442\u0430 \u0437\u0430\u0432\u0430\u043d\u0442\u0430\u0436\u0438\u0442\u0438 Steam<\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<div style=\"clear: left;\"><\/div>\r\n\t\t<\/div>\r\n\t\t<div class=\"got_steam_low_block\">\r\n\t\t\t<div class=\"gotsteam_steam_ico\"><img src=\"http:\/\/store.akamai.steamstatic.com\/public\/images\/v6\/steam_ico.png\" width=\"40\" height=\"40\" border=\"0\" \/><\/div>\r\n\t\t\tSteam \u2014 \u043d\u0430\u0439\u043a\u0440\u0430\u0449\u0430 \u0456\u0433\u0440\u043e\u0432\u0430 \u043f\u043b\u0430\u0442\u0444\u043e\u0440\u043c\u0430 \u043d\u0430 \u041f\u041a. \u0420\u0435\u0454\u0441\u0442\u0440\u0430\u0446\u0456\u044f \u0431\u0435\u0437\u043a\u043e\u0448\u0442\u043e\u0432\u043d\u0430, \u0430 \u043a\u043b\u0456\u0454\u043d\u0442 \u043b\u0435\u0433\u043a\u0438\u0439 \u0443 \u0437\u0430\u0441\u0442\u043e\u0441\u0443\u0432\u0430\u043d\u043d\u0456. <a href=\"http:\/\/store.steampowered.com\/about\/\">\u0414\u0456\u0437\u043d\u0430\u0439\u0442\u0435\u0441\u044f \u043f\u0440\u043e Steam \u0431\u0456\u043b\u044c\u0448\u0435.<\/a>\r\n\t\t<\/div><\/div>\r\n\t<\/div>\r\n<\/div>");
...
{
	var strTemplate = "<div class=\"recommended_more_info_modal\">\r\n\t\t\t\t\t\t\t\t<p class=\"intro\">\u0412\u0438 \u0437\u043d\u0430\u0439\u0448\u043b\u0438 \u0434\u0435\u0449\u043e \u043d\u0435 \u0441\u0445\u043e\u0436\u0435 \u043d\u0430 \u0442\u0435, \u0447\u0438\u043c \u0446\u0456\u043a\u0430\u0432\u0438\u043b\u0438\u0441\u044f \u0443 \u043c\u0438\u043d\u0443\u043b\u043e\u043c\u0443. Steam \u0432\u0438\u0432\u0447\u0430\u0442\u0438\u043c\u0435 \u0432\u0430\u0448\u0456 \u0432\u043f\u043e\u0434\u043e\u0431\u0430\u043d\u043d\u044f \u0447\u0435\u0440\u0435\u0437 \u0437\u0456\u0433\u0440\u0430\u043d\u0456 \u0456\u0433\u0440\u0438, \u043f\u0435\u0440\u0435\u0433\u043b\u044f\u043d\u0443\u0442\u0456 \u0444\u0456\u043b\u044c\u043c\u0438 \u0442\u0430 \u0432\u0438\u043a\u043e\u0440\u0438\u0441\u0442\u043e\u0432\u0443\u0432\u0430\u043d\u0456 \u0437\u0430\u0441\u0442\u043e\u0441\u0443\u043d\u043a\u0438 \u0443 Steam. \u041d\u0430 \u043e\u0441\u043d\u043e\u0432\u0456 \u0446\u0456\u0454\u0457 \u0430\u043a\u0442\u0438\u0432\u043d\u043e\u0441\u0442\u0456 \u043c\u0438 \u043f\u0440\u0438\u0441\u0442\u043e\u0441\u043e\u0432\u0443\u0432\u0430\u0442\u0438\u043c\u0435\u043c\u043e \u0440\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u0430\u0446\u0456\u0457 \u0432\u0456\u0434\u043f\u043e\u0432\u0456\u0434\u043d\u043e \u0434\u043e \u0432\u0430\u0448\u0438\u0445 \u0441\u043c\u0430\u043a\u0456\u0432.<\/p>\r\n\t\t\t\t\t\t\t\t<h2>\u041f\u043e\u0434\u043e\u0431\u0430\u0454\u0442\u044c\u0441\u044f \u0446\u0435\u0439 \u043f\u0440\u043e\u0434\u0443\u043a\u0442?<\/h2>\r\n\t\t\t\t\t\t\t\t<p>\u042f\u043a\u0449\u043e \u0432\u0430\u043c \u043f\u043e\u0434\u043e\u0431\u0430\u0454\u0442\u044c\u0441\u044f \u0446\u0435\u0439 \u043f\u0440\u043e\u0434\u0443\u043a\u0442 \u0456 \u0432\u0438 \u0437\u0431\u0438\u0440\u0430\u0454\u0442\u0435\u0441\u044f \u0439\u043e\u0433\u043e \u043f\u0440\u0438\u0434\u0431\u0430\u0442\u0438 \u0442\u0430 \u0433\u0440\u0430\u0442\u0438, \u0442\u043e\u0434\u0456 \u043c\u0438 \u0437\u0432\u0430\u0436\u0430\u0442\u0438\u043c\u0435\u043c\u043e \u043d\u0430 \u043d\u044c\u043e\u0433\u043e \u043f\u0440\u0438 \u0441\u0442\u0432\u043e\u0440\u0435\u043d\u043d\u0456 \u043f\u043e\u0434\u0430\u043b\u044c\u0448\u0438\u0445 \u0440\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u0430\u0446\u0456\u0439<\/p>\r\n\t\t\t\t\t\t\t\t<h2>\u041d\u0435 \u0446\u0456\u043a\u0430\u0432\u0438\u0442\u044c \u043f\u043e\u0434\u0456\u0431\u043d\u0435?<\/h2>\r\n\t\t\t\t\t\t\t\t<p>\u0412\u0438 \u0442\u0430\u043a\u043e\u0436 \u043c\u043e\u0436\u0435\u0442\u0435 \u0441\u043a\u043e\u043d\u0444\u0456\u0433\u0443\u0440\u0443\u0432\u0430\u0442\u0438 \u0441\u0432\u043e\u0457 \u0432\u043f\u043e\u0434\u043e\u0431\u0430\u043d\u043d\u044f \u043a\u0440\u0430\u043c\u043d\u0438\u0446\u0456, \u0449\u043e\u0431\u0438 \u043f\u043e\u0432\u0456\u0434\u043e\u043c\u0438\u0442\u0438 Steam \u043f\u0440\u043e \u0442\u0435\u0491\u0438 \u0447\u0438 \u0442\u0438\u043f\u0438 \u043f\u0440\u043e\u0434\u0443\u043a\u0442\u0456\u0432, \u044f\u043a\u0456 \u0432\u0430\u0441 \u043d\u0435 \u0446\u0456\u043a\u0430\u0432\u043b\u044f\u0442\u044c. <a href=\"https:\/\/store.steampowered.com\/account\/preferences\/\">\u0412\u0456\u0434\u0432\u0456\u0434\u0430\u0442\u0438 \u0432\u043f\u043e\u0434\u043e\u0431\u0430\u043d\u043d\u044f \u043a\u0440\u0430\u043c\u043d\u0438\u0446\u0456<\/a>.<\/p>\r\n\t\t\t\t\t\t\t<\/div>";
	ShowAlertDialog( "\u0411\u0456\u043b\u044c\u0448\u0435 \u043f\u0440\u043e \u0440\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u0430\u0446\u0456\u0457", strTemplate);
