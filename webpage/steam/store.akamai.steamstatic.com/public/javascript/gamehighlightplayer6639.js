...
HighlightPlayer.prototype.LoadMovie = function( $Container, bUserAction )
{
	...
	else
	{
		...
		var strMessage = 'Υπήρξε ένα σφάλμα κατά την προσπάθεια αναπαραγωγής αυτού του βίντεο. Βεβαιωθείτε ότι ο περιηγητής σας είναι ενημερωμένος.';
	...
	$.fn.videoControls = function( options ) {
		...
		var overlaySrc = '<div class="html5_video_overlay">' +
				...
				'<div class="control_container">' +
					...
					'<div class="autoplay_label">Αυτόματη αναπαραγωγή βίντεο</div>' +
				'</div>' +
