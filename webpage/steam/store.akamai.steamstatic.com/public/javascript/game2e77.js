...
function InitQueueControls( store_appid, steamworks_appid, next_in_queue_appid, snr )
{
	...
	$IgnoreBtn.click( function() {
		$J.post( 'http://store.steampowered.com/recommended/ignorerecommendation/', {
			...
			ShowAlertDialog( 'Ikke interesseret', 'Der opstod et problem i forsøget på at gemme dine ændringer. Prøv venligst igen senere.' );
		});
	});
...
function BuildReviewHistogram()
{
	...
	$J.get( 'http://store.steampowered.com/appreviewhistogram/' + appid, { l: 'danish' }
	).done( function( data ) {
...
function ShowReportDialog( nAppId )
{
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_intro' } ).text('Vælg venligst en grund til at du rapporterer dette produkt.') );
		...
		var rgReportOptions = {"1":"Svindel - <span class=\"sub\">Denne software fors\u00f8ger svigagtigt at indsamle f\u00f8lsomme oplysninger, s\u00e5som Steam-kontooplysninger eller finansielle data (f.eks. kreditkortoplysninger).<\/span>","2":"Skadelig - <span class=\"sub\">Denne software modificerer kundens computer p\u00e5 en uventet eller skadelig m\u00e5de (f.eks. malware eller virus)<\/span>","3":"Hadefulde ytringer - <span class=\"sub\">Indeholder hadefulde ytringer, dvs. ytringer som promoverer had, vold eller diskrimination mod grupper eller mennesker baseret p\u00e5 etnicitet, religion, k\u00f8n, alder, handicap eller seksuel orientering<\/span>","4":"Pornografi - <span class=\"sub\">Indeholder pornografi<\/span>","5":"Voksenindhold - <span class=\"sub\">Indeholder voksenindhold som ikke er ordentligt m\u00e6rket og aldersbegr\u00e6nset<\/span>","6":"\u00c6rekr\u00e6nkende - <span class=\"sub\">Indeholder \u00e6rekr\u00e6nkende eller injurierende ytringer<\/span>","7":"Anst\u00f8deligt - <span class=\"sub\">Indeholder indhold som er \u00e5benlyst anst\u00f8deligt eller beregnet til at chokere eller forarge beskuere<\/span>","8":"B\u00f8rnemisbrug - <span class=\"sub\">Indeholder en hvilken som helst form for udnyttelse af b\u00f8rn<\/span>","11":"Juridisk kr\u00e6nkelse - <span class=\"sub\">Indeholder indhold som overtr\u00e6der loven i din jurisdiktion<\/span>","13":"I stykker - <span class=\"sub\">Downloader, starter eller k\u00f8rer ikke korrekt, selv p\u00e5 en maskine, der m\u00f8der de minimale systemkrav.<\/span>"};
	...
	content.append( $J('<div/>', {'class': 'app_report_dialog_dmca' } ).html('Hvis du ønsker at rapportere en krænkelse af ophavsretten, og er indehaver af den relevante ophavsret, så fortsæt venligst til vores DMCA-ophavsretsklageformular <a href="http://steamcommunity.com/dmca/create/">her</a>.') );
...
{
		var $ModalContent = $J("<div class=\"gotsteamModal\">\r\n\t<div class=\"got_steam_ctn\">\r\n\t<div class=\"got_steam_box\">\r\n\t\t<h1>Har du Steam?<\/h1>\r\n\t\t<p>Du skal have <a href=\"http:\/\/store.steampowered.com\/about\/\">Steam-skrivebordsapplikationen<\/a> installeret f\u00f8r du kan k\u00f8re <strong class=\"gotSteam_AppName\"><\/strong>. Har du Steam installeret p\u00e5 denne computer?<\/p>\r\n\t\t<div class=\"gotsteam_buttons\">\r\n\t\t\t<a class=\"gotSteam_SteamURL btn_blue leftbtn\" href=\"\">\r\n\t\t\t\t<h3>Ja, Steam er installeret<\/h3>\r\n\t\t\t\t<h5 class=\"gotsteam_action\"><\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<a href=\"http:\/\/store.steampowered.com\/about\/\" class=\"btn_blue\">\r\n\t\t\t\t<h3>Nej, jeg har brug for Steam<\/h3>\r\n\t\t\t\t<h5>L\u00e6s om og download Steam<\/h5>\r\n\t\t\t<\/a>\r\n\t\t\t<div style=\"clear: left;\"><\/div>\r\n\t\t<\/div>\r\n\t\t<div class=\"got_steam_low_block\">\r\n\t\t\t<div class=\"gotsteam_steam_ico\"><img src=\"http:\/\/store.akamai.steamstatic.com\/public\/images\/v6\/steam_ico.png\" width=\"40\" height=\"40\" border=\"0\" \/><\/div>\r\n\t\t\tSteam er den bedste m\u00e5de at spille dine PC-spil p\u00e5. Der er gratis at deltage og nemt at bruge. <a href=\"http:\/\/store.steampowered.com\/about\/\">L\u00e6r mere om Steam<\/a>\r\n\t\t<\/div><\/div>\r\n\t<\/div>\r\n<\/div>");
