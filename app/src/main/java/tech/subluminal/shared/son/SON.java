...
public class SON {
    ...
    /**
     * Adds an integer value for a given key (or sequence of keys).
     * Creates a hierarchy of SON objects if necessary.
     *
    ...
    /**
     * Adds a double value for a given key (or sequence of keys).
     * Creates a hierarchy of SON objects if necessary.
     *
     * @param value the value to add.
     * @param key the key to add the value to.
    ...
    /**
     * Adds a boolean value for a given key (or sequence of keys).
     * Creates a hierarchy of SON objects if necessary.
     *
     * @param value the value to add.
     * @param key the key to add the value to.
    ...
    /**
     * Adds a string value for a given key (or sequence of keys).
     * Creates a hierarchy of SON objects if necessary.
     *
     * @param value the value to add.
     * @param key the key to add the value to.
    ...
    /**
     * Adds a SON object for a given key (or sequence of keys).
     * Creates a hierarchy of SON objects if necessary.
     *
     * @param value the value to add.
     * @param key the key to add the value to.
    ...
    /**
     * Adds a SON list for a given key (or sequence of keys).
     * Creates a hierarchy of SON objects if necessary.
     *
     * @param value the value to add.
     * @param key the key to add the value to.
     ...
     * @param additionalKeys an optional sequence of keys to retrieve a value from a nested structure.
