...
public class GameStateDeltaTest {
  ...
  public void stringifyAndParseGameStateDelta() throws SONParsingError, SONConversionError {
    ...
    delta.addPlayer(new Player("1234",
        Optional.of(new Ship(new Coordinates(1.0, 2.3), "4321", Arrays.asList("1", "2", "3"), "3",
            0.2)),
        Arrays.asList(
    ...
    delta.addPlayer(new Player("2345",
        Optional
            .of(new Ship(new Coordinates(10.0, 2.3), "4321", Collections.emptyList(), "5", 0.2)),
        Collections.emptyList()));

    delta.addPlayer(new Player("3456", Optional.empty(), Collections.emptyList()));

    delta.addStar(new Star("1234", 1, new Coordinates(0, 0), "starid", true, 0.1, "Twinkle"));
    delta.addStar(
        new Star(null, 0, new Coordinates(0, 42), "starid2", false, 0.3, "TwinkleTwinkle"));
